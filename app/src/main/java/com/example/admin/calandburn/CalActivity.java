...
public class CalActivity extends AppCompatActivity {
    ...
    private void myAlertDialog(final String strFood, final String strFactor) {
        ...
        objBuilder.setMessage(strFood + " = " + strFactor + " Cal" + "\n" + "กรุณากรอกจำนวน ชาม");
        ...
        objBuilder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                try {
                    ...
                    Toast.makeText(CalActivity.this, "กรุณากรอกจำนวนด้วย คะ", Toast.LENGTH_SHORT).show();
                }
    ...
    private void confirmAlertDialog(final String strDate, final String strFood, String strFactor, final String strAmount) {
        ...
        objBuilder.setMessage(strFactor + " x " + strAmount + " = " + strAnswer);
        objBuilder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
    ...
    private void updateCalaryTABLE(String strDate,
        ...
        Toast.makeText(CalActivity.this, "บันทึก " + strFood + " เรียบร้อยแว้ววว", Toast.LENGTH_SHORT).show();
