...
public class InputProfile extends AppCompatActivity {
    ...
    private String nameString, ageString, heightString, weightString,
            sexString = "male", actString, factorString, dateString, bmiString, bmrString;
    ...
    private void createSpinner() {
        ...
        final String[] factorStrings = {"1.2", "1.375", "1.55", "1.725", "1.9",};
